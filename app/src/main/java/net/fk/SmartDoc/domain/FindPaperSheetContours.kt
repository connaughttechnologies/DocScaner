package net.fk.SmartDoc.domain

import android.graphics.Bitmap
import net.fk.SmartDoc.data.Corners
import net.fk.SmartDoc.support.Either
import net.fk.SmartDoc.support.Left
import net.fk.SmartDoc.support.Right
import net.fk.SmartDoc.extensions.shape
