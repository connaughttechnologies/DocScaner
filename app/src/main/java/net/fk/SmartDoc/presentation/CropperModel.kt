...
import net.fk.SmartDoc.data.Corners
import net.fk.SmartDoc.domain.Failure
import net.fk.SmartDoc.domain.FindPaperSheetContours
import net.fk.SmartDoc.domain.PerspectiveTransform
import net.fk.SmartDoc.domain.UriToBitmap
